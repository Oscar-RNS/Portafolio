    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 -my-14">
        <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-5 text-lg leading-8 text-gray-300">
                Hola, bienvenido a mi sección de portafolio personal para explorar algunos de mis pequeños proyectos
                realizados utilizando las diferentes tecnologias antes mencionadas. Son pequeñas
